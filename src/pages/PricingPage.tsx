...
>>>>>>> 817c90190c11ebb70fbcd656933aee47c4526ed8
    price: '€0',
    description: 'Basic local operational recovery.',
    features: [
      'Local-only sessions',
...
>>>>>>> 817c90190c11ebb70fbcd656933aee47c4526ed8
    price: '€5',
    description: 'Entry-level sync for mobility.',
    features: [
      'Everything in Basic',
      'Cloud Sync (1 Device)',
...
<<<<<<< HEAD
  ...
  },
  {
    ...
    name: 'MindMark Pro',
=======
    stripePriceId: 'price_plus_placeholder',
  },
  {
    id: 'pro',
    name: 'Pro',
>>>>>>> 817c90190c11ebb70fbcd656933aee47c4526ed8
    price: '€10',
    description: 'The standard for high-focus pros.',
    features: [
      'Everything in Plus',
      'Unlimited Device Sync',
      'AI Smart Resume',
      'Advanced Productivity Analytics',
      'Priority Session Restore'
    ],
<<<<<<< HEAD
...
>>>>>>> 817c90190c11ebb70fbcd656933aee47c4526ed8
    price: '€25',
    description: 'Unrestricted collaboration & scaling.',
    features: [
      'Everything in Pro',
      'Collaboration Mode',
...
export function PricingPage() {
  ...
  const handleSubscription = async (tier: PricingTier) => {
    ...
    if (!isAuthenticated) {
      navigate('/signup', { state: { redirect: '/pricing', message: 'Create an account to subscribe.' } });
      return;
    }
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-20 space-y-20">
      ...
      <div className="flex items-center gap-2 text-sm font-medium theme-text-secondary">
        ...
        <span className="theme-text-primary uppercase tracking-widest text-[10px] font-bold">Billing Strategy</span>
      </div>

      <div className="text-center space-y-6 max-w-3xl mx-auto">
        <Badge variant="indigo" size="md">Pricing Tiers</Badge>
        <h1 className="text-4xl sm:text-6xl font-black theme-text-primary tracking-tighter leading-[0.9]">
          Structured plans for <span className="text-indigo-600 dark:text-indigo-400 italic">infinite flow.</span>
        </h1>
        <p className="text-lg theme-text-secondary leading-relaxed font-medium">
          Choose the layer of continuity that matches your professional throughput.
        </p>
      </div>
            ...
            >
              ...
              <div className="mb-8 overflow-hidden">
                ...
                <div className="flex items-baseline gap-1">
                  ...
                  <span className="text-xs theme-text-secondary font-bold uppercase tracking-widest">{tier.id === 'free' ? 'forever' : '/mo'}</span>
                </div>
                <p className="mt-4 text-sm theme-text-secondary font-medium leading-relaxed">{tier.description}</p>
              </div>
              ...
              >
                {currentPlan === tier.id ? 'Active Plan' : isPro ? 'Get Started Now' : `Select ${tier.name}`}
              </Button>
            </motion.div>
          );
        })}
      ...
      <Card variant="ghost" className="p-12 text-center space-y-8 border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/30">
        ...
        <div className="space-y-4">
          <h2 className="text-3xl font-black theme-text-primary tracking-tight">Security-First Infrastructure</h2>
          <p className="theme-text-secondary text-lg max-w-3xl mx-auto leading-relaxed font-medium">
            Payments are handled securely via Stripe. We never store your credit card information. 
            All billing data is encrypted with bank-level security protocols.
          </p>
        </div>
        <div className="flex flex-wrap justify-center gap-6">
          <Link to="/security">
            <Button variant="outline" size="lg" className="px-8 rounded-xl font-bold tracking-widest text-[10px] uppercase">Security Policy</Button>
          </Link>
<<<<<<< HEAD
          <a href="mailto:billing@mindmark.app">
=======
          <a href="mailto:billing@contextsaver.com">
>>>>>>> 817c90190c11ebb70fbcd656933aee47c4526ed8
            <Button variant="ghost" size="lg" className="px-8 font-bold tracking-widest text-[10px] uppercase">Billing Support</Button>
          </a>
        </div>
      </Card>
    </div>
